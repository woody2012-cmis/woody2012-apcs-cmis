public class Roster
{
    ...
    //multi arguments
    public Roster(String first, String last,double English, double Math, double Science, double FineArts, double SocialScience)
    {
    ...
    public Roster findStudentWithMaxGPA() 
    {       
